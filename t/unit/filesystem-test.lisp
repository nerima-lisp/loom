...
;;;; boundary (see packages/feature/file-tree/src/infrastructure-filesystem.lisp's header comment for
...
;;; BUFFER-LOAD / BUFFER-SAVE against the boundary. t/unit/buffer-test.lisp already
