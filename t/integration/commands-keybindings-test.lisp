...
(describe
  ...
  (it-each
      (("find-file" loom::find-file)
       ...
       ("write-file" loom::write-file)
       ("search-forward" loom::search-forward)
       ("search-backward" loom::search-backward)
