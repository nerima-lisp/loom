...
root source tree responsible for every feature."
  ...
  (:file "packages/core/editor/src/domain-buffer-accessors")
   ...
   (:file "src/infrastructure/terminal-renderer-primitives")
   (:file "src/infrastructure/terminal-renderer-cursor")
   (:file "src/infrastructure/terminal-renderer-text")
   (:file "src/infrastructure/terminal-renderer-buffer")
   ...
   (:file "packages/feature/multiple-cursors/src/application-multiple-cursor-support")
   (:file "packages/feature/multiple-cursors/src/application-multiple-cursor-edit-support")
   (:file "packages/feature/multiple-cursors/src/application-commands-multiple-cursor")
   (:file "packages/feature/multiple-cursors/src/application-multiple-cursor-edit-protocol")
...
(asdf:defsystem "loom/test"
  ...
  ((:file "t/package")
   ...
   (:file "t/unit/multiple-cursor-basic-test")
   (:file "t/unit/multiple-cursor-delete-test")
   (:file "t/unit/multiple-cursor-yank-test")
